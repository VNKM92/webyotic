<div class="flex h-screen bg-gray-100">
    <!-- Sidebar -->
    <div class="fixed inset-y-0 left-0 z-50 w-64 bg-gradient-to-b from-gray-900 to-gray-800 transform transition-transform duration-300 ease-in-out md:relative md:transform-none"
        ...
        <nav class="flex-1 overflow-y-auto px-4 py-6 space-y-2">
            ...
            <a href="{{ route('admin.dashboard') }}" 
               class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-200 group {{ request()->routeIs('admin.dashboard') ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-700' }}">
                ...
                <span class="ml-auto text-xs bg-blue-600 rounded-full px-2 py-1 opacity-0 group-hover:opacity-100 transition-opacity">New</span>
            </a>
            ...
            <div class="pt-4 border-t border-gray-700">
                ...
                <a href="{{ route('admin.blogs.index') }}" 
                   class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-200 group {{ request()->routeIs('admin.blogs.*') ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-700' }}">
                    ...
                    <span class="ml-auto text-xs bg-amber-600 rounded-full px-2 py-1">5</span>
                </a>
            ...
            <div class="pt-4 border-t border-gray-700">
                ...
                <a href="#" class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-200 group text-gray-300 hover:bg-gray-700 ml-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                    </svg>
                    <span class="font-medium text-sm">Create Page</span>
                </a>
            </div>
        ...
        <div class="border-t border-gray-700 p-4 space-y-3">
            <div class="flex items-center space-x-3 px-2">
                <div class="w-10 h-10 bg-gradient-to-br from-green-400 to-blue-500 rounded-full flex items-center justify-center text-white font-bold text-lg">
    ...
    <!-- Mobile backdrop -->
    @if ($isOpen)
    <div class="fixed inset-0 z-40 bg-black bg-opacity-50 md:hidden" @click="isOpen = false"></div>
    @endif
</div>
